...
if("TRUE" STREQUAL "TRUE")
  set(px4_SOURCE_PREFIX /home/jinwoo/offboard_test/src/Firmware)
  set(px4_DEVEL_PREFIX /home/jinwoo/offboard_test/devel)
  set(px4_INSTALL_PREFIX "")
  set(px4_PREFIX ${px4_DEVEL_PREFIX})
else()
  set(px4_SOURCE_PREFIX "")
  set(px4_DEVEL_PREFIX "")
  set(px4_INSTALL_PREFIX /home/jinwoo/offboard_test/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'px4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jinwoo/offboard_test/src/Firmware/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jinwoo/offboard_test/devel/lib;/home/jinwoo/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
